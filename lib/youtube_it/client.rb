class YouTubeIt
  class Client
    ...
    def subscription_videos(subscription_id, options = {})
      client.subscription_videos(subscription_id, options)
    end
    ...
    def playlists(opts = {})
      client.playlists(opts)
    end

    def playlist_videos(playlist, opts = {})
      client.playlist_videos(playlist, opts)
    end
